...
class TestDataLoaderKwargs(unittest.TestCase):
    ...
    def test_config_cleanup_preserves_checkpoint_fingerprints(self) -> None:
        """Removing shuffle retains existing default-config checkpoints."""
        config = DistributedDatasetConfig(seq_len=10, local_batch_size=1)
